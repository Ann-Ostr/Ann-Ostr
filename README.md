...
Меня зовут Аня Острицкая. У меня есть скромные умения в разработке и непреодолимое желание набраться опыта разработчика. Владею Python, Django, DRF, SQL, PostgreSQL, Git, Docker.
